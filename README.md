...
Deployable on Heroku, Render, Google App Engine (GAE), Cloud Run and other hosting services using with/without Docker .
---
...
This project is released under the [CC0 1.0 Universal] license, by Masanori Ohgita ([andrewthomas9]).
