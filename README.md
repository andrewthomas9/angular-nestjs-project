...
[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/andrewthomas9/angular-nest/tree/master?file=client%2Fsrc%2Fapp%2Fapp.component.html)
...
Next, please [Create a new repository from this repository](https://github.com/andrewthomas9/angular-nest/generate).
...
See the [Wiki](https://github.com/andrewthomas9/angular-nest/wiki/) for additional information.
...
This app supports direct deployment to [various hosting services](https://github.com/andrewthomas9/angular-nest/wiki/#Deployments) as a production environment.
...
Please see [Deploy to Heroku](https://github.com/andrewthomas9/angular-nest/wiki/Deploy-to-Heroku) page for more informations.
...
Please see [Deploy to Render](https://github.com/andrewthomas9/angular-nest/wiki/Deploy-to-Render) page for more informations.

### Deployment on other servers (with/without Docker)

https://github.com/andrewthomas9/angular-nest/wiki/#Deployments
...
This project is released under the [CC0 1.0 Universal](https://github.com/andrewthomas9/angular-nest/blob/master/LICENSE) license, by Masanori Ohgita ([mugifly](https://github.com/mugifly)).
